...
export default function AdminVehiclesPage() {
  ...
  const openEditForm = (v: any) => {
    ...
    setForm({
      ...
      videos: Array.isArray(v.videos) ? v.videos : v.videos ? JSON.parse(v.videos) : [],
      ...
      specialPackages: Array.isArray(v.specialPackages) ? v.specialPackages : v.specialPackages ? JSON.parse(v.specialPackages) : [],
      techFeatures: Array.isArray(v.techFeatures) ? v.techFeatures : v.techFeatures ? JSON.parse(v.techFeatures) : [],
